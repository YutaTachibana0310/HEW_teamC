...
#define SPEEDCIRCLE_ZERO_POS_X		(TEXTURE_CIRCLE_SIZE_X)						//左のサークルの位置							
#define SPEEDCIRCLE_ZERO_POS_Y		(WINDOW_HEIGHT - TEXTURE_METER_SIZE_Y)		//左のサークルの位置
#define SPEEDCIRCLE_ONE_POS_X		(WINDOW_CENTER_X + TEXTURE_CIRCLE_SIZE_X)	//右のサークルの位置
#define SPEEDCIRCLE_ONE_POS_Y		(WINDOW_HEIGHT - TEXTURE_METER_SIZE_Y)		//右のサークルの位置

#define SPEEDMETER_ZERO_POS_X		(SPEEDCIRCLE_ZERO_POS_X /2)					//左のメーターの位置
#define SPEEDMETER_ZERO_POS_Y		(SPEEDCIRCLE_ZERO_POS_Y)					//左のメーターの位置
#define SPEEDMETER_ONE_POS_X		(WINDOW_CENTER_X + TEXTURE_METER_SIZE_X /2)	//右のメーターの位置
