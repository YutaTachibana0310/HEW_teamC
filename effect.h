...
#define EFFECT_SIZE_X		 (3.0f)										//テクスチャのXサイズ
#define EFFECT_SIZE_Y		 (3.0f)										//テクスチャのYサイズ
...
#define EFFECT_COLOR		 D3DXCOLOR(0.8f, 0.7f, 0.2f, 0.85f)
...
int SetEffect(D3DXVECTOR3 pos, float scale = 1.0f);
#endif