...
#define SCORE_TEXTURE_SIZE_X	(100.0f)
#define SCORE_TEXTURE_SIZE_Y	(100.0f)
#define SCORE_BASEPOS_1P		(D3DXVECTOR3(300.0f, 50.0f, 0.0f))
#define SCORE_BASEPOS_2P		(D3DXVECTOR3(WINDOW_CENTER_X + 300.0f, 30.0f, 0.0f))
#define SCORE_OFFSET			(-30.0f)
